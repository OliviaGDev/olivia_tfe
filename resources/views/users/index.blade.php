          ...
          <tbody>
            ...
            <a href="{{ route('users.edit', $user->id) }}">
              ...
              <th>
                  ...
                  <a href="{{ route('users.edit', $user->id) }}" class="btn-edit-pencil">
                ...
                {{--<img src="{{asset('icons/edit.svg') }}"  width="16px" > --}}
                {{-- <img src="{{asset('img/edit.svg') }}" class="edit-button" width="16px" > --}}
              {{-- <svg src="{{asset('img/edit.svg') }}" class="edit-button" width="16px" > --}}</a>

                  </form>
              </th>
              <th>
                <a href="javascript:void(0)" data-id="{{ $user->id }}" class="delete-user" id="btn-delete-user" width="16px" >
                  <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
